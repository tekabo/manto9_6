...
public class DataBaseHelper extends SQLiteOpenHelper {
	private final static String DATABASE_NAME = "mantu.db";
	...
	public void onCreate(SQLiteDatabase db) {
		//地址表
		db.execSQL("create table if not exists AddressInfo (name varchar(50),address varchar(50),area varchar(50)"
				+ ",phone varchar(50))");
//		
