...
//		propertyid=(int) saving.getLong(LocalStore.PROPERTY_ID, 0);
		...
		startProgressDialog();
		mLogsThread = new PropertyNotificationThread(InformDetailActivity.this, mHandler,propertyid,  mPageNum);
		mLogsThread.start();
	...
	private void startProgressDialog()
	{
		...
		if (mProgressDialog != null)
			mProgressDialog.dismiss();
		mProgressDialog = new ProgressDialog(InformDetailActivity.this);
