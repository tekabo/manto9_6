...
public class LifePayActivity extends BaseActivity{
	...
	private static LifePayAdapter mListAdapter; // TODO 写重复了一个adapter
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i("MyLog", "LifePayActivity+propertyid=");
...
//		propertyid = (int) saving.getLong(LocalStore.PROPERTY_ID, 0);
		...
		Log.i("MyLog", "LifePayActivity+propertyid="+propertyid);
		Log.i("MyLog", "LifePayActivity+flag="+flag);
		Log.i("MyLog", "LifePayActivity+mPageNum="+mPageNum);
//		shoucang_flag= getIntent().getIntExtra(Constants.SHOUCANG_FLAT , 0) ;
		...
		showDialog();
		mThread = new GetCanYinListThread(LifePayActivity.this,
	...
	private void showDialog() {
		...
		if (mProgressDialog != null)
			mProgressDialog.dismiss();
		mProgressDialog = new ProgressDialog(LifePayActivity.this);
	...
	public void showLogsListView(List<LivingItem> list) 
	{
		...
		if(mPageNum == 1)
		{
			...
			mListAdapter = new LifePayAdapter(getApplicationContext(), mThread.getProductList(), mThread.getProductList().size());
